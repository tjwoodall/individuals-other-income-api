...
class Def1_RetrieveOtherValidatorSpec extends UnitSpec {
  ...
  private def validator(nino: String, taxYear: String) = new Def1_RetrieveOtherValidator(nino, taxYear).validateAndWrapResult()
  ...
  "validator" should {
    "return the parsed domain object" when {
      "a valid request is supplied" in {
        ...
        result shouldBe Right(Def1_RetrieveOtherRequestData(parsedNino, parsedTaxYear))
      }
    }
