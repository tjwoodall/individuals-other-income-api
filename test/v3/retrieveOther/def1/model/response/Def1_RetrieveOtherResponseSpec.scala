...
class Def1_RetrieveOtherResponseSpec extends UnitSpec {
  ...
  private val responseModel = Def1_RetrieveOtherResponse(
  ...
  "Def1_RetrieveOtherResponse" when {
    "read from valid JSON" should {
      "produce the expected Def1_RetrieveOtherResponse object" in {
        json.as[Def1_RetrieveOtherResponse] shouldBe responseModel
      }
    }
    ...
    "read from json with empty chargeableForeignBenefitsAndGifts object, businessReceipts and allOtherIncomeReceivedWhilstAbroad arrays" should {
      "produce a JsError" in {
        ...
        invalidJson.validate[Def1_RetrieveOtherResponse] shouldBe a[JsError]
    ...
    "read from empty JSON" should {
      "produce a JsError" in {
        ...
        emptyJson.validate[Def1_RetrieveOtherResponse] shouldBe a[JsError]
      }
    }

    "read from a valid JSON with submittedOn field," should {
      "produce a expected Def1_RetrieveOtherResponse object" in {
        val json = Json.parse(
          """
            |{
        ...
        json.as[Def1_RetrieveOtherResponse] shouldBe
          Def1_RetrieveOtherResponse(submittedOn = Timestamp("2019-04-04T01:01:01.000Z"), None, None, None, None, None)
      }
    }
