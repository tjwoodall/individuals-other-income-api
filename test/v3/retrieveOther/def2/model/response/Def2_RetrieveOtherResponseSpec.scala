...
class Def2_RetrieveOtherResponseSpec extends UnitSpec {
  ...
  private val responseModel = Def2_RetrieveOtherResponse(
  ...
  "Def2_RetrieveOtherResponse" when {
    "read from valid JSON" should {
      "produce the expected Def2_RetrieveOtherResponse object" in {
        json.as[Def2_RetrieveOtherResponse] shouldBe responseModel
      }
    }
    ...
    "read from json with empty chargeableForeignBenefitsAndGifts object, businessReceipts and allOtherIncomeReceivedWhilstAbroad arrays" should {
      "produce a JsError" in {
        ...
        invalidJson.validate[Def2_RetrieveOtherResponse] shouldBe a[JsError]
    ...
    "read from empty JSON" should {
      "produce a JsError" in {
        ...
        emptyJson.validate[Def2_RetrieveOtherResponse] shouldBe a[JsError]
      }
    }

    "read from a valid JSON with submittedOn field," should {
      "produce a expected Def2_RetrieveOtherResponse object" in {
        val json = Json.parse(
          """
            |{
        ...
        json.as[Def2_RetrieveOtherResponse] shouldBe
          Def2_RetrieveOtherResponse(submittedOn = Timestamp("2019-04-04T01:01:01.000Z"), None, None, None, None, None, None)
      }
    }

    "read from a valid JSON with missing foreignTaxCreditRelief field in allOtherIncomeReceivedWhilstAbroad" should {
      "produce an expected Def2_RetrieveOtherResponse object with foreignTaxCreditRelief as false" in {
        val json = Json.parse(
          """
            |{
            |   "submittedOn": "2019-04-04T01:01:01Z",
