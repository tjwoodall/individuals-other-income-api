...
case class NonCashBenefitsFromFormerEmployer(amountBeforeTax: BigDecimal,
...
object NonCashBenefitsFromFormerEmployer {
  implicit val formats: OFormat[NonCashBenefitsFromFormerEmployer] = Json.format[NonCashBenefitsFromFormerEmployer]
}
