...
case class PersonalInsuranceBenefits(amountBeforeTax: BigDecimal,
...
object PersonalInsuranceBenefits {
  implicit val formats: OFormat[PersonalInsuranceBenefits] = Json.format[PersonalInsuranceBenefits]
}
