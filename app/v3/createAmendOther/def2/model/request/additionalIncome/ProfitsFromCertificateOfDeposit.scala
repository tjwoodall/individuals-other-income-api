...
case class ProfitsFromCertificateOfDeposit(amountBeforeTax: BigDecimal,
...
object ProfitsFromCertificateOfDeposit {
  implicit val formats: OFormat[ProfitsFromCertificateOfDeposit] = Json.format[ProfitsFromCertificateOfDeposit]
}
