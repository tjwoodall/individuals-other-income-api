...
case class IncomeFromUnauthorisedUnitTrust(amountBeforeTax: BigDecimal,
...
object IncomeFromUnauthorisedUnitTrust {
  implicit val formats: OFormat[IncomeFromUnauthorisedUnitTrust] = Json.format[IncomeFromUnauthorisedUnitTrust]
}
