...
case class TaxableAnnualPayments(amountBeforeTax: BigDecimal,
...
object TaxableAnnualPayments {
  implicit val formats: OFormat[TaxableAnnualPayments] = Json.format[TaxableAnnualPayments]
}
