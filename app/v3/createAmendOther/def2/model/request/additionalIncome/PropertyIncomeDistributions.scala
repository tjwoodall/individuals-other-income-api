...
case class PropertyIncomeDistributions(amountBeforeTax: BigDecimal,
...
object PropertyIncomeDistributions {
  implicit val formats: OFormat[PropertyIncomeDistributions] = Json.format[PropertyIncomeDistributions]
}
